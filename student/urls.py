...
urlpatterns = [
    ...
    path('search?q=link+for+django+admin&oq=link+for+django+facultyd&aqs=chrome..69i57j0i22i30i457.7240j1j4&sourceid=chrome&ie=UTF-8/', views.stud_all_report, name='stud_all_report'),
